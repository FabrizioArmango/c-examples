...
void Ricerca(char input[], char *r, persona *rubrica, int numPersone)
{
    ...
    else if (strcmp(r, "cognome") == 0)
        str1 = rubrica[i].cognome;

    else if (strcmp(r, "cap") == 0)
...
void CompilaPersona(persona *who)
{
    ...
    printf("\n > Telefono: ");
    scanf("%s", who->telefono);

    printf("\n > Cellulare: ");
    scanf("%s", who->cellulare);

    printf("\n > Indirizzo \n \t > Via: ");
    scanf("%s", who->indirizzo.via);

    printf("\n \t > Citta': ");
    scanf("%s", who->indirizzo.citta);

    printf("\n \t > CAP: ");
    scanf("%s", who->indirizzo.cap);
}
